...
pub use backends::{
    ...
    materialize_task_launch_settings, opencode_catalog, orchestrator_pending,
    parse_grok_models_cache, parse_grok_models_text, parse_omp_models_json,
    parse_opencode_models_verbose, parse_pi_builtin_catalog, parse_pi_models_json,
    parse_pi_models_store, pi_builtin_data_dir, recent_models, record_recent_model,
    resolve_bot_launch_settings, resolve_launch_settings, resolve_opencode_agent,
    resolve_task_launch_settings, sort_efforts, sort_opencode_models, upcoming_run_plan,
